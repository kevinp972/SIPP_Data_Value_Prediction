...
Since **tw** is defined as net financial assets including **ira**, it is expected that there is a linear relationship between **tw** and **ira**, and this is what we can see on the scatterplot, too. Similarly, **nifa** is defined as non-401k financial assets and has a seemingly linear relationship with **tw** despite it having a more data points on the lower end than the higher end of **nifa**. 
...
result = select_optimal_knots(data, "tw", "inc", 20)
print(result$knots_chosen)
print(result$boundary_knots)
print(result$plot)
```